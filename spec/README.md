...
- `v1/predicate-prefixes.json`: source of truth for CURIE prefix mappings.
- `v1/predicate-prefixes.schema.json`: schema rules for predicate prefix mappings.
...
Generated SDK/docs artifacts derived from `spec/v1/entity-types.json` and `spec/v1/predicate-prefixes.json`:
